					            ...
					            <ul class="dropdown-menu">
					            	<c:forEach var="currentBFluid" items="${requestScope.basket}">
					            		<div class="basket-item">
											...
											<c:url value="ShowOne" var="deleteFromBasket">
            ...
            <div class="product-item-holder size-big single-product-gallery small-gallery">
              <div id="owl-single-product">
                <div class="single-product-gallery-item" id="slide1">
                  ...
                  <img class="img-responsive" alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-gallery-01.jpg" />
                  </a>
                </div>
              ...
              <div class="single-product-gallery-thumbs gallery-thumbs">
                <div id="owl-single-product-thumbnails">
                  ...
                  <img width="67" alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/gallery-thumb-01.jpg" />
                  </a>
