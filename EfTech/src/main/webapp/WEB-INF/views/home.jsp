          ...
          <div class="col-xs-12 col-sm-3 no-margin sidebar narrow">
              ...
              <ul class="product-list">
                <li>
                  <div class="row">
                    <div class="col-xs-4 col-sm-4 no-margin">
                      ...
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-01.jpg" />
                      </a>
                    </div>
                    <div class="col-xs-8 col-sm-8 no-margin">
                ...
                <li>
                  <div class="row">
                    <div class="col-xs-4 col-sm-4 no-margin">
                      <a href="#" class="thumb-holder">
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-02.jpg" />
                      </a>
                    </div>
                    <div class="col-xs-8 col-sm-8 no-margin">
                ...
                <li>
                  <div class="row">
                    <div class="col-xs-4 col-sm-4 no-margin">
                      <a href="#" class="thumb-holder">
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-03.jpg" />
                      </a>
                    </div>
                    <div class="col-xs-8 col-sm-8 no-margin">
                      <a href="#">PowerShot Elph 115 16MP Digital Camera</a>
            ...
            <div class="widget">
              <div class="simple-banner">
                <a href="#"><img alt="" class="img-responsive" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/banner/banner-simple.jpg" /></a>
              </div>
            </div>
            <!-- ========================================= FEATURED PRODUCTS ========================================= -->
            <div class="widget">
              ...
              <div id="owl-recommended-products" class="owl-carousel product-grid-holder">
                <div class="no-margin carousel-item product-item-holder hover size-medium">
                  <div class="product-item">
                    ...
                    <div class="image">
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-11.jpg" />
                    </div>
                    <div class="body">
                      <div class="title">
                ...
                <div class="no-margin carousel-item product-item-holder hover size-medium">
                  <div class="product-item">
                    ...
                    <div class="image">
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-12.jpg" />
                    </div>
                    <div class="body">
                      <div class="title">
                ...
                <div class="no-margin carousel-item product-item-holder hover size-medium">
                  <div class="product-item">
                    <div class="image">
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-13.jpg" />
                    </div>
                    <div class="body">
                      <div class="title">
                ...
                <div class="no-margin carousel-item product-item-holder hover size-medium">
                  <div class="product-item">
                    <div class="ribbon blue"><span>new!</span></div>
                    <div class="image">
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-14.jpg" />
                    </div>
                    <div class="body">
                      <div class="title">
                ...
                <div class="no-margin carousel-item product-item-holder hover size-medium">
                  <div class="product-item">
                    ...
                    <div class="image">
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-15.jpg" />
                    </div>
                    <div class="body">
                      <div class="title">
                ...
                <div class="no-margin carousel-item product-item-holder hover size-medium">
                  <div class="product-item">
                    <div class="image">
                      <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-16.jpg" />
                    </div>
                    <div class="body">
                      <div class="title">
                      ...
                      <div class="row no-margin">
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                          <div class="product-item">
                            <div class="ribbon red"><span>sale</span></div>
                            <div class="image">
                              <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-01.jpg" />
                            </div>
                            <div class="body">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                          <div class="product-item">
                            <div class="ribbon blue"><span>new!</span></div>
                            <div class="image">
                              <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-02.jpg" />
                            </div>
                            <div class="body">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                          <div class="product-item">
                            <div class="image">
                              <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-03.jpg" />
                            </div>
                            <div class="body">
                              <div class="label-discount clear"></div>
                              <div class="title">
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                          <div class="product-item">
                            ...
                            <div class="ribbon green"><span>bestseller</span></div>
                            <div class="image">
                              <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-04.jpg" />
                            </div>
                            <div class="body">
                              <div class="label-discount clear"></div>
                              <div class="title">
                    ...
                    <div class="products-list">
                      ...
                      <div class="product-item product-item-holder">
                        ...
                        <div class="row">
                          <div class="no-margin col-xs-12 col-sm-4 image-holder">
                            <div class="image">
                              <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-05.jpg" />
                            </div>
                          </div>
                          <!-- /.image-holder -->
                          <div class="no-margin col-xs-12 col-sm-5 body-holder">
                  ...
                  <ul>
                    <li>
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-3 no-margin">
                          <a href="#" class="thumb-holder">
                          <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-04.jpg" />
                          </a>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-3 no-margin">
                          <a href="#" class="thumb-holder">
                          <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-05.jpg" />
                          </a>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-3 no-margin">
                          <a href="#" class="thumb-holder">
                          <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-06.jpg" />
                          </a>
                        </div>
                      </div>
                    </li>
                  ...
                  <ul>
                    <li>
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-3 no-margin">
                          <a href="#" class="thumb-holder">
                          <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-07.jpg" />
                          </a>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-3 no-margin">
                          <a href="#" class="thumb-holder">
                          <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-08.jpg" />
                          </a>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-3 no-margin">
                          <a href="#" class="thumb-holder">
                          <img alt="" src="resources/Ecommerce/assets/images/blank.gif" data-echo="resources/Ecommerce/assets/images/products/product-small-09.jpg" />
                          </a>
                        </div>
                      </div>
                    </li>
