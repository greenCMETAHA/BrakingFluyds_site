	            	...
	            	<li>
	                   ...
	                   <div class="value">
			                <div class="star-holder inline">
			                  <div class="star" data-score="${currentGood.getJudgement()}" id="Judgement" ></div>
			                </div>
		                </div>
	                 </li>
	                 <li>
	                   ...
	                   <div class="value">
	                   		<input <c:out value="${readOnly}"/> type="text" class="input" value="${currentGood.getName()}" name="name_Good" />
						</div>
	                 </li>
	                 <li>
	                   ...
	                   <div class="value">
	                   		<textarea name="Description"   <c:out value="${readOnly}"/>  
	                   			cols="75" rows="7" class="textarea" ><c:out value="${currentGood.getDescription().trim()}"  /></textarea>
					   </div>
	                 </li>
	                 <li>
	                   <label>Цена:</label>
	                   <div class="value">
	                   		<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_PRICE')">
	                   			<input type="text" class="input" value="${currentGood.getPrice()}" name="Price" />
	                   		</sec:authorize>
	                 ...
	                 <li>
	                   ...
	                   <div class="value">
	                   		<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_PRICE')">
	                   			<input type="text" class="input" value="${currentGood.getDiscount()}" name="Discount" />
	                   		</sec:authorize>
					   </div>
	                 </li>
	                 <li>
	                   ...
	                   <div class="value">
	                   		<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_PRICE')">
	                   			<input type="text" class="input" value="${currentGood.getInStock()}" name="InStock" />
	                   		</sec:authorize>
					   </div>
	                 </li>
	            ...
	            <div class="tab-pane active" id="description">
		            <ul class="tabled-data">
	                    ...
	                    <div class="value">
	                    	<select size="1" name="Manufacturer"  <c:out value="${disabledValue}"/> class="le-select">
			                    <option >Выберите производителя</option>	
									...
									<c:if test="${currentGood.getManufacturer().getName() != punct.getName()}">
	                    ...
	                    <div class="value">
	                    	<select size="1" name="OilStuff"  <c:out value="${disabledValue}"/> class="le-select">
			                    <option >Выберите тип масла</option>	
									...
									<c:if test="${currentGood.getOilStuff().getName() != punct.getName()}">
										<option value="${punct.getName()}"><c:out value="${punct.getName()}"  /></option>
									</c:if>
									<c:if test="${currentGood.getOilStuff().getName() == punct.getName()}">
										<option selected value="${punct.getName()}"><c:out value="${punct.getName()}"  /></option>
	                  ...
	                  <li>
	                    ...
	                    <div class="value">
	                    	<input  <c:out value="${readOnly}"/> type="text" value="${currentGood.getViscosity()}" name="Viscosity" />
						</div>
	                  </li>
	            	  <li>
	                    <label>Объём:</label>
	                    <div class="value">
	                    	<input  <c:out value="${readOnly}"/> type="text" value="${currentGood.getValue()}" name="Value" />
						</div>
	                  </li>
	         		</ul>
	              </div>
	                    	...
	                    	<div class="excerpt">
	                    		<sec:authorize access="!hasAnyRole('ROLE_ADMIN','ROLE_PRODUCT')">
				                	<div><textarea name="Specification" readonly="${readOnly}"
			                		 	cols="90" rows="7" class="textarea" ><c:out value="${currentGood.getSpecification().trim()}"  /></textarea>
			                		</div>
				                </sec:authorize>
	                    		<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_PRODUCT')">
	              ...
	              <div class="tab-pane" id="image">
	                <ul class="tabled-data">
	                  <li>
		                <label></label>
		                <div class="value">	
		                	<c:if test="${currentGood.hasPhoto()}">
						  		<img src="resources/jpg/<c:out value="${currentGood.getPhoto()}"  />" alt="${currentGood.getName()}">
					    	</c:if><p>
					    </div>
					   </li>
  	                   <li>
