...
//    			}else{
//    				ArrayList<BrakingFluid> listBrakingFluids = DownloadDataFromExcel.importFromExcelProduct(
//    							DownloadDataFromExcel.convertMultipartFile(fileEcxel), request.getSession().getServletContext().getRealPath("/")));
//    				
...
//    			}else{
//					ArrayList<BrakingFluid> listBrakingFluids = DownloadDataFromExcel.importFromExcelPrices(DownloadDataFromExcel.convertMultipartFile(fileEcxel));
//		 	        synchronized (listBrakingFluids){
//			         	for (BrakingFluid currentBF:listBrakingFluids){
